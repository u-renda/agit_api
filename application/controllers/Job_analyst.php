...
class Job_analyst extends REST_Controller {

    function __construct()
    {
        parent::__construct();
		$this->load->model('job_analyst_model', 'the_model');
    }
	...
	function create_post()
	{
		...
		if (check_job_analyst_name($name) == FALSE && $name == TRUE)
		{
	...
	function delete_post()
	{
        ...
        $id = filter($this->post('id_job_analyst'));
        ...
        if ($validation == "ok")
		{
            $query = $this->the_model->info(array('id_job_analyst' => $id));
	...
	function lists_get()
	{
		...
		if (in_array($order, $this->config->item('default_job_analyst_order')) && ($order == TRUE))
		{
			$order = $order;
		}
		else
