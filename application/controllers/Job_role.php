...
class Job_role extends REST_Controller {

    function __construct()
    {
        parent::__construct();
		$this->load->model('job_role_model', 'the_model');
    }
	...
	function delete_post()
	{
        ...
        $id = filter($this->post('id_job_role'));
	...
	function info_get()
	{
		...
		$id = filter($this->get('id_job_role'));
	...
	function lists_get()
	{
		...
		if (in_array($order, $this->config->item('default_job_role_order')) && ($order == TRUE))
		{
			$order = $order;
		}
		else
